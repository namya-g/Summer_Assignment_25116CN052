...
void AddMatrices(int sum[100][100],int matrix1[100][100],int matrix2[100][100],int rows,int columns)
{
    for(int i=0;i<rows;i++)
    {
        for(int j=0;j<columns;j++)
...
int main()
{
    int r1,c1,mat1[100][100],r2,c2,mat2[100][100],sum[100][100];
    ...
    if((r1==r2)&&(c1==c2))
    {
        ...
        AddMatrices(sum,mat1,mat2,r1,c1);
